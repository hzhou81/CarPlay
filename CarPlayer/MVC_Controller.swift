...
class MVC_Controller {
    ...
    //
    func addAlbumIDAtRightPlace( idArray: inout Array<NSNumber>, albumTitle: String, albumIDToBeAdded: NSNumber) {
        ...
        for index in 0 ..< idArray.count {
            ...
            if albumTitle < albumTitleAtIndexPosition {
                ...
                idArray.insert(albumIDToBeAdded, at: index)
    ...
    func shortNameForLongName(longName: String) -> String {
        ...
        if longName.hasPrefix("The ") || longName.hasPrefix("Die ") {
            ...
            let index: String.Index = longName.startIndex.advanced(by: 4)
            return longName.substring(from: index)
    ...
    func createPlaylist(artist: String, albumIDList: Array<NSNumber>) {
        ...
        for albumID in albumIDList {
            ...
            query = (albumIsPlaylist ? MPMediaQuery.albums() : MPMediaQuery.songs())
        ...
        _musicPlayer.setQueue(with: mediaCollection)
    }
    ...
    func createPlayListOfCurrentArtistAndAlbumIDs() {
        ...
        createPlaylist(artist: _currentArtist!, albumIDList: _currentAlbumIDList!)
    }
    ...
    func createPlayListOfCurrentArtist(albumIDList: Array<NSNumber>) {
        ...
        createPlaylist(artist: _currentArtist!, albumIDList: albumIDList)
    }
    ...
    func setCurrentAlbumIDList(albumIDList: Array<NSNumber>, setShuffleMode: Bool) {
        ...
        checkIfUserSelectionHasChanged(albumIDList: albumIDList, setShuffleMode: setShuffleMode)
    ...
    func checkIfUserSelectionHasChanged(albumIDList: Array<NSNumber>, setShuffleMode: Bool) {
        ...
        for albumID in albumIDList {
            ...
            if ((_currentAlbumIDList!).index(of: albumID) == nil) {
...
*/
    ...
    func currentTrackHasLyrics() -> Bool {
        ...
        let songURL = _musicPlayer.nowPlayingItem!.value(forProperty: MPMediaItemPropertyAssetURL) as! NSURL?
        if songURL == nil {

            return false
        }
        let asset=AVURLAsset(url: songURL! as URL, options: nil)
        //let asset = AVURLAsset(URL: songURL! as URL, options: nil)
        let lyrics: NSString! = asset.lyrics! as NSString
...
*/
    ...
    func getAlbumData(albumID: NSNumber) ->  (albumName: String, artwork: MPMediaItemArtwork?, numOfTracks: Int) {
        ...
        let name = albumName(albumID: albumID)
        ...
        let numOfTracks = numberOfTracksForAlbumID(albumID: albumID)
    ...
    func setBrightness(pinchScale: CGFloat) {
        ...
        var curVal = UIScreen.main.brightness
    ...
    func advanceSpeedDisplayMode() {
        ...
        _savior.saveSpeedDisplayMode(valueOfDisplayMode: _speedDisplayMode)
    }
    ...
    func printAlbumListOfCurrentArtist() {
        ...
        printAlbumListOfArtist(artistName: _currentArtist!)
    }
