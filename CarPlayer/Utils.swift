...
extension UIView {
    ...
    class func animateStrongShake(itemToShake: UIView, completion: ((Bool) -> Void)?) {
        ...
        let durationForOneDirection: TimeInterval = 0.1
        ...
        UIView.animate(
            ...
            animations: {
                itemToShake.transform = CGAffineTransform(rotationAngle: CGFloat(M_PI) * shakeWidth)
        ...
        UIView.animate(
            ...
            usingSpringWithDamping: dampingForSwings,
            initialSpringVelocity: 0.0,
            //options: UIViewAnimationOptions.curveLinearcurveLinear,
            options:UIViewAnimationOptions.curveLinear,
            animations: {
                itemToShake.transform = CGAffineTransform(rotationAngle: CGFloat(M_PI) * (-1) * shakeWidth)
        ...
        UIView.animate(
            ...
            options: UIViewAnimationOptions.curveLinear,
            animations: {
                itemToShake.transform = CGAffineTransform(rotationAngle: 0.0)
    ...
    class func animateSlightShrink(itemToShrink: UIView, completion: ((Bool) -> Void)?) {
        ...
        animateWithShrink(itemToShrink: itemToShrink, shrinkingFactor: shrinkingFactor, completion: completion)
    }
    ...
    class func animateWithShrink(itemToShrink: UIView, shrinkingFactor: CGFloat, completion: ((Bool) -> Void)?) {
        ...
        UIView.animate(
            ...
            options: UIViewAnimationOptions.curveLinear,
            animations: {
                itemToShrink.transform = CGAffineTransform(scaleX: 1.0 - shrinkingFactor, y: 1.0 - shrinkingFactor)
        ...
        UIView.animate(
            ...
            options: UIViewAnimationOptions.curveLinear,
            animations: {
                itemToShrink.transform = CGAffineTransform(scaleX: 1.0, y: 1.0)
    ...
    class func animateSlightGrowthInYDir(itemToGrow: UIView, completion: ((Bool) -> Void)?) {
        ...
        animateWithGrowth(itemToGrow: itemToGrow, growthFactorX: 0.0, growthFactorY: growthFactor, completion: completion)
    }
    ...
    class func animateWithGrowth(itemToGrow: UIView, growthFactorX: CGFloat, growthFactorY: CGFloat, completion: ((Bool) -> Void)?) {
        ...
        UIView.animate(
            ...
            options: UIViewAnimationOptions.curveLinear,
            animations: {
                itemToGrow.transform = CGAffineTransform(scaleX: 1.0 + growthFactorX, y: 1.0 + growthFactorY)
...
*/
        UIView.animate(
            ...
            options: UIViewAnimationOptions.curveLinear,
            animations: {
                itemToGrow.transform = CGAffineTransform(scaleX: 1.0, y: 1.0)
    ...
    class func animateMoveOutToLeft(itemToMoveOut: UIView, completion: ((Bool) -> Void)?) {
        ...
        let durationForOneDirection: TimeInterval = 0.2
        ...
        UIView.animate(
            ...
            animations: {
                itemToMoveOut.transform = CGAffineTransform(translationX: -1.0 * CGFloat(MyBasics.screenWidth), y: 0.0)
    ...
    class func animateLongishLabel(
        ...
        UIView.animate(
            withDuration: timeForAnimation / 2.0,
    ...
    class func slideSmoothlyToPosition(scrollView: UIScrollView, pointToSlideTo: CGPoint) {
        ...
        slideSmoothlyToPosition(scrollView: scrollView, delay: 0.0, pointToSlideTo: pointToSlideTo)
    }
...
*/
    ...
    class func jumpSpringyToPosition(scrollView: UIScrollView, pointToJumpTo: CGPoint) {
        jumpSpringyToPosition(scrollView: scrollView, delay: 0.0, pointToJumpTo: pointToJumpTo)
    }
...
extension UIImage {
    ...
    func getPixelColor(pos: CGPoint) -> UIColor {
        ...
        (r, g, b, a) = getPixelColorValues(pos: pos)
