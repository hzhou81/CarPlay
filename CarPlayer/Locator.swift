...
class Locator: CLLocationManager, CLLocationManagerDelegate {
    ...
    //
    func setNotifierFunction(funcToCall: @escaping (Int, String, String, String, String, Double, CLLocationCoordinate2D) -> Void) {
    ...
    func locationManager(manager: CLLocationManager, didUpdateLocations locations: [CLLocation]) {
        ...
        let latString = getNiceLatStringFromCoord(coord: coord.latitude)
        let longString = getNiceLongStringFromCoord(coord: coord.longitude)
        let altString = (getI18NedDecimalString(str: altitude.format(f: ".0")) + " m")
        let courseString = (course >= 0 ? (getI18NedDecimalString(str: course.format(f: ".0")) + "°") : defaultCourse())
    ...
    func getNiceLatStringFromCoord(coord: Double) -> String {
        ...
        return getNiceStringFromCoord(coord: coord, posChar: "N", negChar: "S")

    }

    func getNiceLongStringFromCoord(coord: Double) -> String {

        return getNiceStringFromCoord(coord: coord, posChar: "E", negChar: "W")
    ...
    func getNiceStringFromCoord(coord: Double, posChar: Character, negChar: Character) -> String {
        ...
        // Make "008" from "8":
        resultStr = intPartOfCoord.format(f: "03")
        ...
        resultStr = resultStr + "° " + intPartOfMinutes.format(f: "02") + separatorChar
        ...
        resultStr = resultStr + intPartOfSeconds.format(f: "01") + "' "
