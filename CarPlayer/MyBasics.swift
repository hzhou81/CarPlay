...
class MyBasics {
    ...
    class func PlayerView_ArtistLabel_YPos(displayMode: Int) -> CGFloat {
        ...
        case 0: // off
            return PlayerView_ProgressBar_YPos(displayMode: displayMode) - 100.0
        case 1: // speed only
            return PlayerView_ProgressBar_YPos(displayMode: displayMode) - 100.0
        case 2: // all
            return PlayerView_ProgressBar_YPos(displayMode: displayMode) - 78.0
        default:
    ...
    class func PlayerView_FrameForArtistLabel(displayMode: Int) -> CGRect {
        ...
        return CGRect(
            origin: CGPoint(x: PlayerView_ArtistLabel_XPos, y: PlayerView_ArtistLabel_YPos(displayMode: displayMode)),
    ...
    class func PlayerView_LeftPositionOfArtistLabel(displayMode: Int) -> CGPoint {
        ...
        return CGPoint(x: PlayerView_ArtistLabel_XPos, y: PlayerView_ArtistLabel_YPos(displayMode: displayMode))
    ...
    class func PlayerView_RightPositionOfArtistLabel(displayMode: Int) -> CGPoint {
        ...
        return CGPoint(
            ...
            y: PlayerView_ArtistLabel_YPos(displayMode: displayMode)
        )
    }
    ...
    class func PlayerView_ProgressBar_YPos(displayMode: Int) -> CGFloat {
        ...
        case 0: // off
            return PlayerView_TrackTitleLabel_YPos(displayMode: displayMode) - 25.0
        case 1: // speed only
            return PlayerView_TrackTitleLabel_YPos(displayMode: displayMode) - 25.0
        case 2: // all
            return PlayerView_TrackTitleLabel_YPos(displayMode: displayMode) - 10.0
        default:
    ...
    class func PlayerView_ProgressBar_Width(displayMode: Int) -> CGFloat {
        ...
        case 0: // off
            return CGFloat(screenWidth) - 2 * PlayerView_ProgressBar_XPos(displayMode: displayMode)
        case 1: // speed only
            return CGFloat(screenWidth) - 2 * PlayerView_ProgressBar_XPos(displayMode: displayMode)
        case 2: // all
    ...
    class func PlayerView_FrameForProgressBar(displayMode: Int) -> CGRect {
        ...
        return CGRect(
            origin: CGPoint(x: PlayerView_ProgressBar_XPos(displayMode: displayMode), y: PlayerView_ProgressBar_YPos(displayMode: displayMode)),
            size: CGSize(width: PlayerView_ProgressBar_Width(displayMode: displayMode), height: PlayerView_ProgressBar_Height)
        )
    }
    ...
    class func PlayerView_LeftPositionOfTrackTitle(displayMode: Int) -> CGPoint {
        ...
        return CGPoint(x: PlayerView_TrackTitleLabel_XPos(displayMode: displayMode), y: PlayerView_TrackTitleLabel_YPos(displayMode: displayMode))
    ...
    class func PlayerView_RightPositionOfTrackTitle(displayMode: Int) -> CGPoint {
        ...
        return CGPoint(
            x: PlayerView_TrackTitleLabel_XPos(displayMode: displayMode) + PlayerView_TrackTitleLabel_Width(displayMode: displayMode),
            y: PlayerView_TrackTitleLabel_YPos(displayMode: displayMode)
        )
    }

    class func PlayerView_SizeForTrackTitle(displayMode: Int) -> CGSize {

        return CGSize(width: PlayerView_TrackTitleLabel_Width(displayMode: displayMode), height: PlayerView_TrackTitleLabel_Height)
    }

    class func PlayerView_FrameForTrackTitle(displayMode: Int) -> CGRect {

        return CGRect(
            origin: CGPoint(x: PlayerView_TrackTitleLabel_XPos(displayMode: displayMode), y: PlayerView_TrackTitleLabel_YPos(displayMode: displayMode)),
            size: PlayerView_SizeForTrackTitle(displayMode: displayMode)
        )
    }
    ...
    class func PlayerView_SliderButtons_YPos(displayMode: Int) -> CGFloat {
        ...
        return PlayerView_ProgressBar_YPos(displayMode: displayMode)
    }

    class func PlayerView_SliderButtons_XStartPos(displayMode: Int) -> CGFloat {

        return PlayerView_ProgressBar_XPos(displayMode: displayMode)
    }

    class func PlayerView_SliderButtons_SliderWidth(displayMode: Int) -> CGFloat {

        return PlayerView_ProgressBar_Width(displayMode: displayMode)
    }
