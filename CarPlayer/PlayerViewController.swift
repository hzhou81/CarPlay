...
class PlayerViewController: UIViewController, UIGestureRecognizerDelegate {
    ...
    override func viewDidLoad() {
        ...
        _locator.setNotifierFunction(funcToCall: self.updateSpeedDisplay)
    ...
    func setLabelsAndButtons() {
     ...
     //   var nowPlayingItem = _controller.nowPlayingItem()
        ...
        if _controller.currentNumberOfTracksIsKnown() {
            ...
            _trackListButton.isHidden = false
            ...
            _trackListButton.isHidden = true
        }

        // Set the parameters for the progress bar:
        _progressBar.frame = MyBasics.PlayerView_FrameForProgressBar(displayMode: _controller.speedDisplayMode())
        _progressBar.trackTintColor = UIColor.darkGray
        _progressBar.tintColor = UIColor.white
    ...
    func createArtistDisplay() {
        ...
        _artistLabel.textColor = UIColor.white
        ...
        //_artistContainerView = UIView(frame: MyBasics.PlayerView_FrameForArtistLabel(displayMode: displayMode,: _controller.speedDisplayMode()))
    ...
    func createTrackTitleDisplay() {
        ...
        _trackTitleLabel.textColor = UIColor.white
        ...
        // Only do the animation if the text does not fit into the container:
        if _trackTitleLabelStartingFrame.width > MyBasics.PlayerView_TrackTitleLabel_Width(displayMode: _controller.speedDisplayMode()) {
            ...
            _trackTitleLabel.frame = CGRect(x: 0, y: 0,
                                            width: MyBasics.PlayerView_TrackTitleLabel_Width(displayMode: _controller.speedDisplayMode()),
    ...
    func finalizePositionOfTrackTitle() {
        ...
        _trackTitleContainerView.frame = MyBasics.PlayerView_FrameForTrackTitle(displayMode: _controller.speedDisplayMode())
        ...
        if !_controller.currentNumberOfTracksIsKnown() || _controller.currentNumberOfTracks() > 1 {
            ...
            let panGesture = UIPanGestureRecognizer(target: self,
                                                    action: #selector(PlayerViewController.trackTitleLabelPanned(recognizer:)))
    ...
    func showArtistAndTrackTitle() {
        ...
        let durationForOneDirection: TimeInterval = 0.6
        UIView.animate(
            withDuration: durationForOneDirection,
            delay: 0.0,
    ...
    func createAlbumDisplay() {
        ...
        _albumLabel.textColor = UIColor.white
    ...
    func animationTimerFired() {
        ...
        _animationTimer = Timer.scheduledTimer(
            timeInterval: MyBasics.PlayerView_TimeForAnimation + MyBasics.PlayerView_TimeForToWaitForNextAnimation * 2,
            target: self,
        ...
        if _artistLabelNeedsAnimation {
            ...
            UIView.animateLongishLabel(
                labelToAnimate: labelToAnimate,: _artistLabel,
        ...
        if _trackTitleLabelNeedsAnimation {
            ...
            UIView.animateLongishLabel(
                labelToAnimate: _trackTitleLabel,
                frameAroundLabel: _trackTitleLabelStartingFrame,
                timeForAnimation: MyBasics.PlayerView_TimeForAnimation,
                timeToWaitForNextAnimation: MyBasics.PlayerView_TimeForToWaitForNextAnimation,
                totalWidth: MyBasics.PlayerView_TrackTitleLabel_Width(displayMode: _controller.speedDisplayMode())
            )
        }
    ...
    func createBackGround() {
        ...
        _albumCoverImage.image = nowPlayingItem.artwork!.image(at: sizeOfArtistImage)
        ...
        let artworkImage: UIImage? = nowPlayingItem.artwork!.image(at: sizeOfView)
 ...
 //       let context = UIGraphicsGetCurrentContext()
        ...
        artworkImage!.draw(in: CGRect(x:0, y:0, width:1, height:1))
        ...
        let backColor = imageWithOneColor.getPixelColor(pos: CGPoint(x:0, y:0))
        ...
        if lightnessFactor > 0.0 {
            ...
            let params: [ String : AnyObject ] = [ kCIContextUseSoftwareRenderer : true as AnyObject as AnyObject ]
            ...
            let darkenedImageData = darkenFilter!.value(forKey: kCIOutputImageKey) as! CIImage
            let darkenedImageRef = ciContext.createCGImage(darkenedImageData, from: darkenedImageData.extent)
    ...
    func createSliderButtons() {
        ...
        for index in 0 ..< numberOfButtons {
            ...
            button.addTarget(self, action: #selector(PlayerViewController.sliderButtonTapped(sender:)), for: .touchDown)
            button.setPosition(pos: Double(index) / Double(numberOfButtons))
    ...
    func updateSliderButtons() {
        ...
        let xStartPos: CGFloat = MyBasics.PlayerView_SliderButtons_XStartPos(displayMode: _controller.speedDisplayMode())
        let yPos: CGFloat = MyBasics.PlayerView_SliderButtons_YPos(displayMode: _controller.speedDisplayMode())
        let sliderWidth: CGFloat = MyBasics.PlayerView_SliderButtons_SliderWidth(displayMode: _controller.speedDisplayMode())
    ...
    func resetAnimationTimer() {
        ...
        stopAnimationTimer()
        _animationTimer = Timer.scheduledTimer(
            timeInterval: MyBasics.PlayerView_TimeForToWaitForNextAnimation,
            target: self,
            selector: #selector(PlayerViewController.animationTimerFired),
            userInfo: nil,
            repeats: false)
    ...
    func trackTitleLabelPanned(recognizer: UIPanGestureRecognizer) {
        ...
        var translation: CGFloat = recognizer.translation(in: self.view).x
        ...
        if scaleFactor < scaleThreshold {
            ...
            let durationForOneDirection: TimeInterval = 0.5
            UIView.animate(
                withDuration: durationForOneDirection,
                delay: 0.0,
                options: UIViewAnimationOptions.curveEaseOut,
    ...
    //    let fullWidth: CGFloat = CGFloat(MyBasics.screenWidth)
        ...
        // Speed label:
        _speedLabel = UILabel()
        _speedLabel.frame = CGRect(x:0, y:MyBasics.PlayerView_speed_yPos, width:speedLabelWidth, height:labelHeight)
        ...
        _latLabel = UILabel()
        _latLabel.frame = CGRect(x:curXPos, y:MyBasics.PlayerView_speed_yPos, width:2*labelWidth, height:labelHeight / 2)
        _latLabel.font = MyBasics.fontForMediumText
        _latLabel.textColor = UIColor.white
        view.addSubview(_latLabel)
        _longLabel = UILabel()
        _longLabel.frame = CGRect(x:curXPos, y:MyBasics.PlayerView_speed_yPos + labelHeight/2, width:2*labelWidth, height:labelHeight / 2)
        ...
        // Altitude:
        _altLabel = UILabel()
        _altLabel.frame = CGRect(x:curXPos, y:MyBasics.PlayerView_speed_yPos, width:labelWidth, height:labelHeight)
        ...
        _courseLabel.frame = CGRect(x:curXPos-2, y:CGFloat(MyBasics.screenHeight) - (labelHeight * 3/4) + 5, width:labelWidth, height:labelHeight)
        _courseLabel.font = MyBasics.fontForSmallThinText
        _courseLabel.textAlignment = NSTextAlignment.center
        _courseLabel.textColor = UIColor.white
        view.addSubview(_courseLabel)

        _courseArrow = UIImageView(image: UIImage(named: "arrow.png"))
        _courseArrow.frame = CGRect(x:curXPos+20, y:MyBasics.PlayerView_speed_yPos+15, width:labelHeight / 2, height:labelHeight / 2)
        _courseArrow.alpha = 0.0
        _crossLines = UIImageView(image: UIImage(named: "crosslines.png"))
        _crossLines.frame = CGRect(x:curXPos+20, y:MyBasics.PlayerView_speed_yPos+15, width:labelHeight / 2, height:labelHeight / 2)
    ...
    func moveLabels() {
        ...
        UIView.jumpSpringyToPosition(uiView:_artistContainerView, delay: delayForArtist[_controller.speedDisplayMode()],
                                     frameToJumpTo: MyBasics.PlayerView_FrameForArtistLabel(displayMode: _controller.speedDisplayMode()))

        UIView.jumpSpringyToPosition(uiView:_progressBar, delay: delayForProgressBar, frameToJumpTo: MyBasics.PlayerView_FrameForProgressBar(displayMode: _controller.speedDisplayMode()))

        UIView.jumpSpringyToPosition(
            uiView:  _trackTitleContainerView, delay: delayForTrackTitle[_controller.speedDisplayMode()],
            frameToJumpTo: MyBasics.PlayerView_FrameForTrackTitle(displayMode: _controller.speedDisplayMode()),
            completion: { finished in
        ...
        case 2:
            ...
            if course >= 0 {
                ...
                UIView.animate(withDuration: 0.5,
                    animations: {
                        self._courseArrow.transform = CGAffineTransform(rotationAngle: 2*CGFloat(M_PI) * (CGFloat(course)/360))
                })
            } else {
    ...
    @IBAction func lyricsButtonTapped(sender: UIButton) {
        ...
        UIView.animateSlightShrink(
            itemToShrink: _albumCoverImage,
            completion: { finished in
                self.present(lyricsView, animated: true, completion: nil)
        })
    }
    ...
    func sliderButtonTapped(sender: UIButtonWithFeatures) {
        ...
        UIView.animateSlightGrowthInYDir(
            itemToGrow: _progressBar,
            completion: { finished in

                // Set the current track to the defined position.
                // The parameter must be between 0.0 and 1.0.
                _controller.setCurrentTrackPosition(newPosition: sender.position())
            }
        )
    ...
    @IBAction func startAndPauseButtonTapped(sender: UIButton) {
        ...
        UIView.animateTinyShrink(itemToShrink: self.view, completion: nil)
    ...
    @IBAction func userHasSwipedUp(sender: UISwipeGestureRecognizer) {
        ...
        performSegue(withIdentifier: MyBasics.nameOfSegue_playerToSpeed, sender: self)
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.destination.title! != MyBasics.nameOfSpeedView {
            ...
            _slidingTransition.setDirectionToStartWith(direction: TransitionManager_Sliding.DirectionToStartWith.Up)
            speedView.setDirectionToSwipeBack(direction: SpeedViewController.DirectionToSwipeBack.Down)
